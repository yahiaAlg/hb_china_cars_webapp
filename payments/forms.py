...
class PaymentForm(forms.ModelForm):
    ...
    class Meta:
        model = Payment
        fields = [
            'payment_date', 'invoice', 'amount', 'payment_method',
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Row(
                Column(
                    Submit('submit', 'Enregistrer le Paiement', css_class='btn btn-primary'),
...
class PaymentReminderForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            'reminder_date', 'reminder_type', 'message',
            'customer_response', 'follow_up_date'
        ]
        widgets = {
...
class PaymentPlanForm(forms.ModelForm):
    ...
    class Meta:
        model = PaymentPlan
        fields = [
            'total_amount', 'down_payment', 'number_of_installments',
            'start_date', 'notes'
        ]
        widgets = {
...
class OutstandingInvoicesFilterForm(forms.Form):
    ...
    days_overdue_min = forms.IntegerField(
        ...
        widget=forms.NumberInput(attrs={
            'placeholder': 'Jours de retard min',
            'class': 'form-control'
        })
    )
