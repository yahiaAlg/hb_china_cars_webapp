...
urlpatterns = [
    ...
    path(
        "reminder/<int:invoice_id>/",
        views.payment_reminder_create,
        name="create_reminder",
    ),
    path(
        "payment-plan/<int:invoice_id>/",
        views.payment_plan_create,
        name="create_payment_plan",
    ),
    path(
        "payment-plan/detail/<int:pk>/",
        views.payment_plan_detail,
        name="payment_plan_detail",
    ),
    path(
        "installment/<int:installment_id>/payment/",
        views.installment_payment,
        name="installment_payment",
    ),
    path(
        "ajax/invoice-balance/", views.ajax_invoice_balance, name="ajax_invoice_balance"
    ),
    path("receipt/<int:invoice_id>/", views.invoice_receipt, name="invoice_receipt"),
]
